...
import DisplayPrescriptionDetails from './DisplayPrescriptionDetails';

const DisplayPrescription = ({ prescription, onBack }) => {
    ...
    const captureAndSharePDF = async () => {
        try {
            ...
            const filename = `מרשם_${prescription.medicine}_עבור_${prescription.name}_${prescription.appointment_date}.pdf`;
        ...
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.goBackContainer}>
                <TouchableOpacity style={styles.goBackButton} onPress={onBack}>
                    <Text style={styles.goBackText}>חזרה לרשימת המרשמים</Text>
